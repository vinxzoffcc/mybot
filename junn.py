...
async def inline_handler(event):
    ...
    caption = """📌 <b>Halo! Selamat datang di Alpha Userbot</b>
<blockquote>
...
<u>⏤͟͟͞͞Update di Versi 1.0.0</u>
• Tombol interaktif untuk navigasi lebih cepat  
• Fitur tambahan dengan API khusus  
• Semua fitur resmi dari <a href="https://t.me/VinnOffcial">Vinn Official</a>  
💡 Tip: Klik tombol untuk melihat fitur dan panduan penggunaannya.  
════════════════════  
🚀 Nikmati pengalaman baru dengan Userbot V1.0.0!</blockquote>"""
...
async def inline_handler(event):
    ...
    result = builder.article(
        title="📌 All Menu",
        text=f"""<blockquote>
( ! ) Welcome to Alpha Bot Version 1.0
...
▢ .unblock id ==> buka blokiran penggunaa
——————————————————————————————
Notes : bot ini hanyalah bot biasa dan gunakan sewajarnya karena ini adalah telegram bukan Whatsapp yang bila kamu terkena blokir akan susah untuk di pulihkan, jika ingin tau lebih lanjut bisa hubungi <a href="https://t.me/VinnOffcial">Owner disini ✨</a>
</blockquote>""",
            buttons=[[Button.inline("⬅ Kembali", data=b"back_main")]],
            parse_mode="html",
            link_preview=False
...
Notes : bot ini hanyalah bot biasa dan gunakan sewajarnya karena ini adalah telegram bukan Whatsapp yang bila kamu terkena blokir akan susah untuk di pulihkan, jika ingin tau lebih lanjut bisa hubungi <a href="https://t.me/VinnOffcial">Owner disini ✨</a>
        ...
        await event.edit("""📌 <b>Halo ini adalah menu Alpha Bot Version 1.0</b>
<blockquote>
...
kamu mendapatkan fitur lebih yaitu biaa button dan dapat extra fitur yang dimana fitur ini menyediakan api tertentu dan pastinya sudah di sediakan oleh <a href="https://t.me/VinnOffcial">Jun Official</a> pastinya jadi tunggu apalagi cobain fitur baru dari penyedia userbot ini
</blockquote>""",
            buttons=[[Button.inline("⬅ Kembali", data=b"back_main")]],
            parse_mode="html",
            link_preview=False
...
async def callback_handler(event):
    ...
    [Button.inline("𝚂𝙷𝚄𝚃𝙳𝙾𝚆𝙽 𝚄𝚂𝙴𝚁𝙱𝙾𝚃", b"shutdown_userbot")]
        ...
        await event.edit(
            """📌 <b>Halo! Selamat datang di Alpha Bot</b>
<blockquote>
<u>⏤͟͟͞͞Menu & Panduan</u>
Gunakan tombol di bawah untuk menjelajahi semua fitur.  
Fitur terbagi menjadi dua bagian utama:
...
• Tombol interaktif untuk navigasi lebih cepat  
• Fitur tambahan dengan API khusus  
• Semua fitur resmi dari <a href="https://t.me/VinnOffcial">Jun Official</a>  
💡 Tip: Klik tombol untuk melihat fitur dan panduan penggunaannya.  
════════════════════  
🚀 Nikmati pengalaman baru dengan Alpha Bot!</blockquote>""",
            buttons=keyboard,
            parse_mode="html",
            link_preview=False
        )
...
async def help_handler(event):
    ...
    caption = """📌 <b>Halo! Selamat datang di Alpha Bot</b>
<blockquote>
<u>⏤͟͟͞͞Menu & Panduan</u>
Gunakan tombol di bawah untuk menjelajahi semua fitur.  
Fitur terbagi menjadi dua bagian utama:
...
🚀 Nikmati pengalaman baru dengan Alpha Bot!</blockquote>"""
    await bot_client.send_file(
        ...
        parse_mode="html",
        force_document=True,  
        attributes=[DocumentAttributeFilename(file_name="USERBOT VERSION 1.0.0")]
    )
from telethon import events, Button
import asyncio
CALLBACK_ACTIONS = {}
